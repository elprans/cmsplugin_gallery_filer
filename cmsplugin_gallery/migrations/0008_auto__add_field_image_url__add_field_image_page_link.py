...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_gallery_image', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Image.page_link'
        db.add_column('cmsplugin_gallery_image', 'page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.url'
        db.delete_column('cmsplugin_gallery_image', 'url')

        # Deleting field 'Image.page_link'
        db.delete_column('cmsplugin_gallery_image', 'page_link_id')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 24, 18, 34, 53, 224490)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
